...
/**
 * Created by andreamantani on 15/05/16.
 */
public class ProfilePhotoItem extends LinearLayout {

    int index;
    FrameLayout deleteLayout;
    String imagePath;

    public ProfilePhotoItem(Context context, AttributeSet attrs, OnClickListener listener, String imagePath, OnClickListener delete, int dimension){
        super(context, attrs);

        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = layoutInflater.inflate(R.layout.profile_photo_item, this);
    ...
    public ProfilePhotoItem(Context context, AttributeSet attrs, OnClickListener listener){
        super(context, attrs);
